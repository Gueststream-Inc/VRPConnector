...
// Widgets
class vrpSearchForm_Widget extends \WP_Widget {

    public function __construct() {
        parent::__construct(
            'vrpsearch_widget',
            'VRPSearch Widget',
            array( 'description' => 'A Widget for adding VRPSearch' ) 
        );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        <div class='vrpsearch-widget'>
            <?php if(isset($title) && $title != "" ) { ?><h3 class='widget-title'><?php echo $title ?></h3><?php } ?>
...
add_action( 'widgets_init', function() { register_widget( 'Gueststream\vrpSearchForm_Widget' ); } );
