...
class oceanbreeze
{
    ...
    function my_scripts_method()
    {
        if (file_exists(get_stylesheet_directory() . '/vrp/css/jquery-ui-1.11.2.custom/jquery-ui.js')) {
            ...
            wp_register_script( 'VRPjQueryUI', plugins_url('/oceanbreeze/css/jquery-ui-1.11.2.custom/jquery-ui.js', dirname(__FILE__)), array('jquery') );
        }
        ...
        if (file_exists(get_stylesheet_directory() . '/vrp/js/vrp.namespace.js')) {
            ...
            wp_register_script('vrpNamespace', plugins_url('/oceanbreeze/js/vrp.namespace.js', dirname(__FILE__)), array( 'jquery' ) );
        }
        ...
        if (file_exists(get_stylesheet_directory() . '/vrp/js/vrp.map.js')) {
            ...
            wp_register_script('vrpMapModule', plugins_url('/oceanbreeze/js/vrp.map.js', dirname(__FILE__)), array( 'jquery' ) );
        }
        ...
        if (file_exists(get_stylesheet_directory() . '/vrp/js/vrp.mRespond.js')) {
            ...
            wp_register_script('vrpMRespondModule', plugins_url('/oceanbreeze/js/vrp.mRespond.js', dirname(__FILE__)), array( 'jquery' ) );
        }
        ...
        if (file_exists(get_stylesheet_directory() . '/vrp/js/vrp.ui.js')) {
            ...
            wp_register_script('vrpUIModule', plugins_url('/oceanbreeze/js/vrp.ui.js', dirname(__FILE__)), array( 'jquery' ) );
        }
        ...
        if (file_exists(get_stylesheet_directory() . '/vrp/js/vrp.queryString.js')) {
            ...
            wp_register_script('vrpQueryStringModule', plugins_url('/oceanbreeze/js/vrp.queryString.js', dirname(__FILE__)), array( 'jquery' ));
        }
        ...
        if (file_exists(get_stylesheet_directory() . '/vrp/js/js.js')) {
            ...
            wp_enqueue_script('VRPthemeJS', plugins_url('/oceanbreeze/js/js.js', dirname(__FILE__)), array( 'jquery' ) );
        }
...
//      }
    ...
    function add_my_stylesheet()
    {
         ...
         if (file_exists(get_stylesheet_directory() . '/vrp/css/font-awesome.css')) {
            ...
            wp_enqueue_style('FontAwesome', plugins_url('/oceanbreeze/css/font-awesome.css', dirname(__FILE__)));
        }
        ...
        if (file_exists(get_stylesheet_directory() . '/vrp/css/jquery-ui-1.11.2.custom/jquery-ui.css')) {
            ...
            wp_enqueue_style('VRPjQueryUISmoothness',
                plugins_url('/oceanbreeze/css/jquery-ui-1.11.2.custom/jquery-ui.css', dirname(__FILE__)));
        }

        if (!file_exists(get_stylesheet_directory() . '/vrp/css/css.css')) {
            $myStyleUrl = plugins_url(
                '/oceanbreeze/css/css.css', dirname(__FILE__)
            );
        } else {
