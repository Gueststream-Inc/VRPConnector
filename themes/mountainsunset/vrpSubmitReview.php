...
<div id="vrp">
    ...
    <form id="vrpSubmitReviewForm">
        ...
        <div class="vrp-col-md-6">
            ...
            <input type="text" name="arrivalDate" id="arrivalDate" readonly/>
        </div>
        ...
        <div class="vrp-col-md-12">
            ...
            <fieldset>
                <span class="star-cb-group">
                  <input type="radio" id="rating-5" name="overallRating" value="5"/><label for="rating-5">5</label>
                  <input type="radio" id="rating-4" name="overallRating" value="4"/><label for="rating-4">4</label>
                  <input type="radio" id="rating-3" name="overallRating" value="3"/><label for="rating-3">3</label>
                  <input type="radio" id="rating-2" name="overallRating" value="2"/><label for="rating-2">2</label>
                  <input type="radio" id="rating-1" name="overallRating" value="1"/><label for="rating-1">1</label>
                  <input type="radio" id="rating-0" name="overallRating" value="0" class="star-cb-clear"
                         checked="checked"/><label for="rating-0">0</label>
                </span>
            </fieldset>
        </div>
        ...
        <div class="vrp-col-md-12">
            ...
            <input type="text" name="reviewName" id="revieName">
        </div>

        <!-- Review Description -->
        <div class="vrp-col-md-12">
            <label for="review-description">Your review</label>
            <textarea name="reviewDescription" id="review-description" maxlength="250"></textarea>
        ...
        <div class="vrp-col-md-12 review-submit">
            <button type="submit" class="vrp-btn">Submit Review</button>
        </div>
